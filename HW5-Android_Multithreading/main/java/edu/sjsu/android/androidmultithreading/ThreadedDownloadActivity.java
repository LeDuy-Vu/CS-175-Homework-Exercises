...
public class ThreadedDownloadActivity extends AppCompatActivity
{
	...
	public void runRunnables(View view)
	{
		try
		{
			...
			progressDialog.setMessage("Downloading via Runnables") ;
			progressDialog.show() ;
			...
			new Thread(new Runnable()   // new thread
			{
				public void run()
				{
					...
					handler.post(new Runnable() // handler
					{
						public void run()
						{
	...
	public class AsyncTaskFromUrl extends AsyncTask<String, Void, Bitmap>
	{
		...
		@Override protected void onPostExecute(Bitmap bitmap)
		{
			if (bitmap == null)
			{
				Toast.makeText(ThreadedDownloadActivity.this, "Error: " + errorMessage, Toast.LENGTH_SHORT).show() ;
				return;
			}
	...
	class ThreadHandlerMainClass extends Handler
	{
		...
		public void handleMessage(Message msg)
		{
			...
			else Toast.makeText(ThreadedDownloadActivity.this, "Error", Toast.LENGTH_SHORT).show() ;
		}
	}
}